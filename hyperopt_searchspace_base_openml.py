...
class run_hyperopt(object):
    ...
    def make_search_space(self):
        search_space={
            ...
            'classifier':hp.choice('classifier',[
                ...
                'max_features': hp.choice('randomforestclassifier__max_features', ['auto', 'sqrt', 'log2',0.15,0.25,0.3,0.4,0.45]),
                ...
                {'type':'gradientboostingclassifier',
                 ...
                 'min_samples_split':hp.choice('gradientboostingclassifier__min_samples_split',[2,9,10]),
                ...
                {'type':'svc',
                 ...
                 'kernel':hp.choice('svc__kernel',["linear", "sigmoid",'rbf']),
                ...
                {'type':'sgdclassifier',
                 ...
                 'max_iter':hp.choice('sgdclassifier__max_iter',range(5,1000)),
    ...
    def objective(self,params):
        ...
        try:
            ...
            self.time_tracker.append(['start',start])
            ...
            self.time_tracker.append(['end',end])
            return {'loss': -accuracy, 'status': STATUS_OK}
        except Exception as e:
            print(e)
            print("The config has problem")
            end = datetime.datetime.now()
            self.time_tracker.append(['end_fail',end])
...
if __name__ == '__main__':
    ...
    #capture the time
    runner.time_tracker.append(['0start',datetime.datetime.now()])
    ...
    temp.trial_utils(trials_inside,0,1000)
    temp.time_tracker_plot(runner.time_tracker, 'time', 'iteration', 'time(sec)}', show_plot=True)

    # pickle.dump(trials_inside, open('./results/result_openml_searchspace/5000trial_0initial_openml_space.p', 'wb'))
    # pickle.dump(runner.time_tracker, open('./results/result_openml_searchspace/5000trial_0initial_openml_space_timetracker.p', 'wb'))
